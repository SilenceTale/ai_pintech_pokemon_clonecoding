package org.koreait.koreait.admin.board.controllers;
...
public class BoardController implements SubMenus {
     ...
     */
    @GetMapping("/add")
    public String add(@ModelAttribute org.koreait.admin.board.controllers.RequestBoard form, Model model) {
    ...
    public String edit(@PathVariable("bid") String bid, Model model) {
        ...
        org.koreait.admin.board.controllers.RequestBoard form = configInfoService.getForm(bid);
