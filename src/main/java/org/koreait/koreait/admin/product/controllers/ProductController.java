package org.koreait.koreait.admin.product.controllers;
...
public class ProductController implements SubMenus {
     ...
     */
    @GetMapping("/add")
    public String add(@ModelAttribute org.koreait.admin.product.controllers.RequestProduct form, Model model) {
