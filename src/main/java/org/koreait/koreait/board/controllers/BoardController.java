package org.koreait.koreait.board.controllers;
...
public class BoardController {
    ...
    public String write(@PathVariable("bid") String bid, @ModelAttribute org.koreait.board.controllers.RequestBoard form, Model model) {
    ...
    public String edit(@PathVariable("seq") Long seq, Model model, @SessionAttribute("commonValue") CommonValue commonValue) {
        ...
        org.koreait.board.controllers.RequestBoard form = boardInfoService.getForm(commonValue.getData());
