package org.koreait.koreait.member.controllers;
...
public class MemberController {
    ...
    public org.koreait.member.controllers.RequestAgree requestAgree() {
        return new org.koreait.member.controllers.RequestAgree();
    }

    @ModelAttribute("requestLogin")
    public org.koreait.member.controllers.RequestLogin requestLogin() {
        return new org.koreait.member.controllers.RequestLogin();
    }
     ...
     */
    @PostMapping("/join")
    public String join(org.koreait.member.controllers.RequestAgree agree, Errors errors, @ModelAttribute org.koreait.member.controllers.RequestJoin form, Model model, @SessionAttribute(name="socialChannel", required = false) SocialChannel socialChannel, @SessionAttribute(name="socialToken", required = false) String socialToken) {
