...
public class PythonRunTest {
    ...
    void test1() throws Exception {
        ProcessBuilder builder = new ProcessBuilder("C:\\Users\\admin\\AppData\\Local\\Programs\\Python\\Python39\\python.exe", "C:/recommend/train.py", "http://localhost:3000/api/dl/data");
